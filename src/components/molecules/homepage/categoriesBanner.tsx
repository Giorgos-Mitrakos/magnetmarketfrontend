...
// Full skeleton — για όταν δεν υπάρχουν categories
...
// Μόνο τα items skeleton — για το loading του dynamic import
// (είμαστε ήδη μέσα στο section, δεν χρειάζεται ξανά)
...
// ✅ Dynamic import — loading δείχνει μόνο τα items, όχι το section ξανά
const CategoriesSwiper = dynamic(() => import('./CategoriesSwiper'), {
  ssr: false,
  loading: () => <CategoriesItemsSkeleton />
})
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        {/* loading δείχνει CategoriesItemsSkeleton — μόνο τα items */}
