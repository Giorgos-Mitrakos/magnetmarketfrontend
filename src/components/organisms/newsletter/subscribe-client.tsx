// app/newsletter/subscribe/subscribe-client.tsx
'use client';
...
export default function SubscribeClient() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-800 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md mx-auto bg-white dark:bg-slate-700 rounded-lg shadow-md overflow-hidden">
                <div className="px-6 py-8">
                    <div className="text-center">
                        <h1 className="text-3xl font-bold text-siteColors-purple dark:text-purple-400">
                    ...
                    <form className="mt-8 space-y-6" onSubmit={handleSubmit} aria-label="Φόρμα εγγραφής newsletter">
                        <div>
                            ...
                            <input
                                ...
                                className="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-slate-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-slate-600 dark:text-slate-100"
                    ...
                    <div className="mt-4 text-center">
                        <p className="text-xs text-slate-500 dark:text-slate-400">
                            Με την εγγραφή συμφωνείτε να λαμβάνετε emails με προσφορές και νέα
                        </p>
                    </div>
                </div>
            </div>
