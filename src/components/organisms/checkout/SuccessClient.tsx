...
export default async function SuccessClient({ orderCookie, ApprovalCodeCookie }:
    { orderCookie: RequestCookie | undefined, ApprovalCodeCookie: RequestCookie | undefined }) {
