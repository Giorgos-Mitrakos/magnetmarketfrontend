...
import { IOrderCookie } from "./SuccessClient";

export default async function FailureClient({ orderCookie, rcfCookie }:
    { orderCookie: RequestCookie | undefined, rcfCookie: RequestCookie | undefined }) {
