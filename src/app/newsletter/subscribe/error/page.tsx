...
export default function SubscribeErrorPage() {
  ...
  const errorMessage = searchParams.get('message') || 'Προέκυψε κάποιο σφάλμα κατά την εγγραφή.';
  ...
  return (
    <div className="bg-slate-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white p-8 rounded-lg shadow-md text-center">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Σφάλμα Εγγραφής</h2>
        ...
        <div className="space-y-3">
          ...
          <a
            href="/"
            className="w-full inline-flex justify-center items-center px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-800"
          >
